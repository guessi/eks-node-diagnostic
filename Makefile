...
# Build flags
LDFLAGS     := -s -w \
               -X "$(REPO)/internal/variables.GitVersion=$(GITVERSION)" \
               -X "$(REPO)/internal/variables.GoVersion=$(GOVERSION)" \
               -X "$(REPO)/internal/variables.BuildTime=$(BUILDTIME)"
